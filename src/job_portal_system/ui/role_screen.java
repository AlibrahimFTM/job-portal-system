...
public class role_screen extends javax.swing.JFrame {
...
// تمديد الصورة لتتناسب مع أبعاد JLabel
...
imagelabel.setIcon(new ImageIcon(scaled));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select   the Role  in System");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          register_student_screan l = new register_student_screan();
        l.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
          ...
          register_company_screan l = new register_company_screan();
        l.setVisible(true);
        l.setLocationRelativeTo(null);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
            register_profosor_screan l = new register_profosor_screan();
        l.setVisible(true);
        l.setLocationRelativeTo(null);
        l.setDefaultCloseOperation(DISPOSE_ON_CLOSE  ); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(role_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new role_screen().setVisible(true);
            }
        });
    }
